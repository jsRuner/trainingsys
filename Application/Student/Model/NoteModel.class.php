...
class NoteModel extends Model
{
    ...
    protected $_validate = array(
        array('content', 'require', '笔记不能为空', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
    );
     ...
     */
    public function updateNote($data = null)
    {
        # code...
        /* 获取数据对象 */
     ...
     */
    public function lists($cid, $lid = false, $status = 1, $order = 'seq DESC', $field = true, $Page = null)
    {
     ...
     */
    public function addCourse($data = null)
    {
        # code...
        /* 获取数据对象 */
        $data = $this->create($data);
    ...
    /**
     * 删除某一个具体的笔记。
     * @param  string $nid [笔记的id]
     * @return [type]      [description]
     */
    public function deleteDataByNid($nid = '')
    {

...
use Teacher\Model\AuthRuleModel;
use Teacher\Model\AuthGroupModel;
/**
 * 教师通用控制器
...
class TeacherController extends Controller {
    ...
    protected function _initialize(){
        ...
        //检查是否是教师。
        if (!isTeacher(session('user_auth.uid'))) {
        ...
        // 获取当前用户ID
        if(defined('UID')) return ; //检变量是否存在，存在则返回，不执行。
        define('UID',is_login());
        if( !UID ){// 还没登录 跳转到登录页面

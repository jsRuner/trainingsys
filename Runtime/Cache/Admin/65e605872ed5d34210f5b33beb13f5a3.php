...
<body>
	...
	<div class="cf">
		<div class="fl">
            ...
            <button class="btn ajax-post" url="<?php echo U('changeStatus?method=teacher');?>" target-form="ids">提为教师</button>
            <button class="btn ajax-post" url="<?php echo U('changeStatus?method=student');?>" target-form="ids">降为学生</button>
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td>
				<?php if($vo["isteacher"] == 1): ?>是<?php else: ?>否<?php endif; ?>
			</td>

  ...
  <div class="col-md-8 col-md-offset-2 col-sm-12">
    <div class="row">
     ...
     <div class="row">
      ...
      <?php if(is_array($teacherList)): $i = 0; $__LIST__ = $teacherList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 1 );++$i;?><h4 style="display:block; color:red;"><?php echo ($key+1); ?>、<?php echo ($vo["title"]); ?></h4>
        <?php echo ($vo['article']['content']); endforeach; endif; else: echo "" ;endif; ?>

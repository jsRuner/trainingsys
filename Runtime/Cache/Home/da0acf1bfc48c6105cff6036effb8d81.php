...
<body>
  ...
  <div class="row wwf-row-ban">
    
    <div class="col-md-8 col-md-offset-2">
      
      
        <img src="/Public/Home/images/ban2.jpg">
...
<div class="row wwf-courselist">
  <div class="col-md-8 col-md-offset-2 col-sm-12">
     ...
     <div class="row wwf-itemrow">
      ...
      <?php if(is_array($courseList)): $i = 0; $__LIST__ = $courseList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 4 );++$i;?><div class="col-md-3">
        <a href="<?php echo U('Home/Course/detail',array('id'=>$vo['id']));?>" class="wwf-courseitem">
          <div class="media">
            <div class="imgdiv" align="center">
              <img src="<?php echo ($vo['large_picture']); ?>" alt="<?php echo ($vo['title']); ?>" style="height:167px" class="img-rounded">
            </div>
      ...
      <?php if(($mod) == "3"): ?></div>
      <div class="row wwf-itemrow"><?php endif; endforeach; endif; else: echo "" ;endif; ?>

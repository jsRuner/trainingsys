  ...
  <div class="panel-body">
    <ul class="list-group">
        <li class="list-group-item">
          ...
          <a href="<?php echo u('Student/MyClass/index');?>">我的课程</a>
        </li>
        <li class="list-group-item">
          <span class="glyphicon glyphicon-file"></span>
          <a href="<?php echo u('Student/Note/index');?>">我的笔记</a>
        </li>
        <li class="list-group-item">
          <span class="glyphicon glyphicon-pencil"></span>
            <a href="<?php echo u('Student/Daily/index');?>">我的日记</a>
        </li>
         <li class="list-group-item">
          <span class="glyphicon glyphicon-book"></span>
            <a href="/Kaoshi/index.php?exam-api-login&<?php echo ($parstr); ?>">我的考试</a>
        </li>
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <div class="row course-list">
            ...
            <?php if(is_array($courseList['courses'])): $i = 0; $__LIST__ = $courseList['courses'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 4 );++$i;?><div class="col-md-3">
                <span class="glyphicon glyphicon-remove pull-right deleBtn" style="display:none" va="<?php echo ($vo['id']); ?>" dt="<?php echo ($vo['title']); ?>" ></span>
                <a href="<?php echo U('Student/Note/listNote',array('cid'=> $vo['id']));?>" class="wwf-courseitem">
                  <div class="media">
                    <div class="imgdiv" align=center>
                      <img src="<?php echo ($vo['middle_picture']); ?>" alt="<?php echo ($vo['title']); ?>"  class="img-rounded"></div>
              ...
              <?php if(($mod) == "3"): ?></div>
              <div class="row course-list"><?php endif; endforeach; endif; else: echo "" ;endif; ?>
...
//模态窗口关闭后刷新页面
  ...
  $(".deleBtn").bind('click',function(){
    var url01 = "<?php echo u('Student/Note/deleteNotes');?>";

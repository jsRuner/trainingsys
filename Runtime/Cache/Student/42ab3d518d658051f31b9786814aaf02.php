...
<img class="image" src="<?php echo get_userphoto();?>" /> 
 ...
 <div class="row">
  ...
  <div class="panel-heading">
     <?php if(empty($lessonData)): ?>"<?php echo ($courseData['title']); ?>" 的相关笔记
         <?php else: ?>
            "<?php echo ($lessonData['title']); ?>" 的相关笔记<?php endif; ?>
      </div>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <a href="<?php echo u('Home/Course/detail',array('id'=>$courseData['id']));?>">
     <h4>课程:<?php echo ($courseData['title']); ?></h4>

    </a>

      <?php if(!empty($lessonData)): ?><a href="<?php echo u('Home/Course/detailLesson',array('id'=>$lessonData['id']));?>">
              <h4>课时:<?php echo ($lessonData['title']); ?></h4>

...
<img class="image" src="<?php echo get_userphoto();?>" /> 
 ...
 <div class="row">
  ...
  <div class="panel-body">
    ...
    <form action="/index.php?s=/Student/Note/editorNote/id/220.html" method="post">
  <fieldset>
     <legend>编辑笔记</legend>
    <div class="form-group">
                <label for="course-about">笔记内容</label>
                <textarea name="content"  class="form-control" id="course-about" cols="30" rows="10" placeholder="输入笔记内容"><?php echo ($noteData['content']); ?></textarea>
   ...
   <div class="form-group pull-right">
    ...
    <input type="hidden" name="id" value="<?php echo ($noteData['id']); ?>">
  </fieldset>
</form>

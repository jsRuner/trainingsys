    ...
    <div class="col-md-7">
      ...
      <div class="panel panel-default panel-col lesson-manage-panel">
        ...
        <div class="panel-body">
           ...
           <?php if(empty($memberData['photo'])): ?><p>你尚未设置个人头像</p>

             <a href="<?php echo u('Student/Setting/setPhoto',array('id'=>$memberData['id'],'step'=>2));?>" class="btn btn-success">去添加</a>


            <?php else: ?>
            <img src="<?php echo ($memberData['photo']); ?>">
         <p>原图</p>
         

         <img src="<?php echo ($memberData['large_photo']); ?>">
         <p>162*162</p>
        
         <img src="<?php echo ($memberData['middle_photo']); ?>">
         <p>48*48</p>
         <img src="<?php echo ($memberData['small_photo']); ?>">
         <p>20*20</p>
     

         <a href="<?php echo u('Student/Setting/setPhoto',array('id'=>$memberData['id'],'step'=>2));?>" class="btn btn-success">编辑</a><?php endif; ?>
...
//点击后初始化
  ...
  // alert(data);
  var m ="<?php echo u('user/getDepartment');?>";
  ...
  //alert(data);
  var m ="<?php echo u('user/getProfession');?>";

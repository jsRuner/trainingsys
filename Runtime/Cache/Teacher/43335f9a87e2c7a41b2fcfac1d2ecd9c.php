			...
			<div class="col-md-9">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<?php if(empty($courseData['picture'])): ?><p>你尚未设置课程的封面图片</p>

             <a href="<?php echo u('Teacher/Course/setPicture',array('id'=>$courseData['id'],'step'=>2));?>" class="btn btn-success">去添加</a>


            <?php else: ?>
            <img src="<?php echo ($courseData['picture']); ?>">
         <p>原图</p>
         

         <img src="<?php echo ($courseData['large_picture']); ?>">
         <p>162*162</p>
        
         <img src="<?php echo ($courseData['middle_picture']); ?>">
         <p>48*48</p>
         <img src="<?php echo ($courseData['small_picture']); ?>">
         <p>20*20</p>
     

         <a href="<?php echo u('Teacher/Course/setPicture',array('id'=>$courseData['id'],'step'=>2));?>" class="btn btn-success">编辑</a><?php endif; ?>
